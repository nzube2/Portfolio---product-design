    ...
    <div className="thermal-page">
      ...
      <div className="thermal-body">
        ...
        <div className="thermal-meta-card">
          ...
          />
          <MetaItem
            icon={<TeamIcon className="thermal-meta-icon thermal-meta-icon-team" />}
        ...
        <section className="thermal-problem">
          ...
          <div className="thermal-problem-body">
            ...
            <p>
              Spotify&apos;s recommendation engine has become a mirror. The
              more you use it, the more it reflects your existing taste back
              at you — the same artists, the same sounds, slightly
              reshuffled. Discovery has been replaced by confirmation.
              Finding genuinely new music now requires a special kind of
              patience and intentionality that most people don&apos;t have
              time for, and shouldn&apos;t have to develop just to enjoy
              music.
            </p>
            <p>
              The problem isn&apos;t that good music doesn&apos;t exist.
              It&apos;s that the tools built to surface it stopped being
              curious on your behalf.
            </p>
          </div>
        </section>
        ...
        <section className="thermal-concept">
          ...
          <p className="thermal-concept-body">
            Thermal began with a natural phenomenon I considered while
            growing up in Nigeria. There are places where hot and cold water
            meet in the same body of water but never fully mix (
            <a
            ...
            distinct energies coexist, each with its own character, and the
            boundary between them is alive and shifting.
          </p>
        </section>
        ...
        <div className="thermal-concept-2">
          <div className="thermal-concept-2-card">
            <p className="thermal-concept-2-body">
              ...
              opposites but because they exist on a spectrum. The feeling a
              song gives you isn&apos;t a genre. It isn&apos;t a BPM count.
              It&apos;s a temperature. That became the design principle:
            </p>
            ...
            <div className="thermal-quote">
              ...
              <p className="thermal-quote-text">
                what if you could find music by describing how you want to
                feel, not what you already know you like?
              </p>
              <img
                src={thermalQuoteMark}
                alt=""
        ...
        <section className="thermal-who-for">
          ...
          <p className="thermal-who-for-body">
            Thermal is for two types of people who are really the same
            person in different moods. The first is the music lover who
            craves a particular sound and wants more of it. They seek out
            more artists like their favorite, more songs with that energy,
            more of whatever that feeling is. They know what they want but
            ...
            &ldquo;here&apos;s what you listened to last Tuesday.&rdquo;
            Thermal supports both by asking a different first question.
            Instead of &ldquo;what do you like?&rdquo; it asks, &ldquo;what
            do you need right now?&rdquo;
          </p>
        </section>
        ...
        <section className="thermal-design-decisions">
          ...
          <div className="thermal-decision-item">
            ...
            <p className="thermal-decision-body">
              ...
              signifies mellow, introspective, and chill. The middle
              point—where the two meet without completely mixing—is warm.
            </p>
          </div>
        </section>
        ...
        <div className="thermal-mood-group">
          ...
          <p className="thermal-mood-caption">
            &ldquo;The temperature slider — energy level and emotional
            context in one interaction&rdquo;
          </p>
        </div>
        ...
        <section className="thermal-discovery-subsection">
          ...
          <p className="thermal-discovery-caption">
            &ldquo;The slider appears on every screen — the temperature
            concept runs through the entire system&rdquo;
          </p>
        </section>
        ...
        <section className="thermal-decision-2">
          <div className="thermal-decision-item">
            ...
            <p className="thermal-decision-body">
              Similar Music, Similar Artiste, Genre, Mood, and Shuffle are
              not the main focus. The temperature is the main feature. The
              modes are starting points, different ways for Thermal to have
              a reference. Each mode alters the input method, but the
              temperature slider and playlist logic remain the same. The
              mode tells Thermal where to search, while the temperature
              indicates how to feel.
            </p>
          </div>
        </section>
        ...
        <section className="thermal-decision-3">
          <div className="thermal-decision-item">
            ...
            <p className="thermal-decision-body">
              ...
              Kendrick Lamar, Lana Del Ray, Bad Bunny, with an icon to
              shuffle through those suggestions. An empty search field
              places the entire burden on the user to know what
              they&apos;re looking for before they even get a chance to
              touch the product; The Popular Choices row offers a
              low-commitment way into the system. Those four artists offer
              distinctly different vibes (pop, hip hop, indie, latin), so
              no matter how broad your taste, something is bound to spark
              some inspiration.
            </p>
          </div>
        </section>
        ...
        <div className="thermal-artiste-group">
          ...
          <p className="thermal-artiste-caption">
            &ldquo;Popular Options-an easy first step in commitment which
            solves the blank input issue&rdquo;
          </p>
        </div>
        ...
        <section className="thermal-decision-4">
          <div className="thermal-decision-item">
            ...
            <p className="thermal-decision-body">
              ...
              displays an analysis state: a single waveform that shifts
              from warm orange at the left to cool teal at the right, with
              &ldquo;Analyzing reference music...&rdquo; below it. Many
              apps treat their loading states as dead space, but this is
              where the premise of Thermal becomes most apparent. The
              waveform visually displays the temperature of music -- hot
              and cold energy blending within a single sound wave --
              explaining to you what the AI is doing in an accessible, if
              abstract, way.
            </p>
          </div>
        </section>
        ...
        <section className="thermal-decision-5">
          <div className="thermal-decision-item">
            ...
            <p className="thermal-decision-body">
              The results page kicks off with one line: &ldquo;30 Songs
              Curated set to cool mode.&rdquo; That line does the following
              three things at once: confirms the temp settings stuck;
              indicates how many results were produced; and positions the
              upcoming stream as deliberated rather than machine generated.
              Every result provides album artwork, playback controls
              (including two preview-play buttons), and both title and
              artist for the selection. Minus/Plus toggles offer both song
              exclusion, as well as the addition of more like music-in
              this, it&apos;s just a starting point.
            </p>
          </div>
        </section>
        ...
        <div className="thermal-results-group">
          ...
          <p className="thermal-results-caption">
            &ldquo;Every detail speaks the same language — the text confirms
            the temperature, the scrollbar reflects it&rdquo;
          </p>
        </div>
        ...
        <section className="thermal-decision-6">
          <div className="thermal-decision-item">
            ...
            <p className="thermal-decision-body">
              The temperature metaphor isn&apos;t a visual theme. It&apos;s
              the logic the entire product is built on, present in the
              brand, the core interaction, the microcopy, and the smallest
              UI details. That consistency was the most deliberate decision
        ...
        <section className="thermal-reflection">
          ...
          <p className="thermal-reflection-body">
            The one thing, to be honest with you, that I&apos;ve since
            changed my mind about is the slider. We put that onto every
            individual screen at first. That made sense to me at the time
            because it put that temperature control visibly in front of
            people on every screen. But sitting with it, the one thing I
            thought was like oh, now we&apos;re making the user do the same
            interaction again, and again, and again, which is probably
            something that isn&apos;t optimal. And the new design
            I&apos;m heading to now is to set that one temperature one
            time in the header when you get to the product, and it sticks
            with you everywhere else. The idea remains the same,
            you&apos;re always within a temperature, but you&apos;re not
            having to reconfirm it, constantly touching that thing again.
            And that&apos;s really the only thing, outside of that, that I
            would necessarily change. The wireframing came before the
            polishing. It&apos;s exactly the order I&apos;d want to go
            into things in again, and the only place I&apos;d maybe spend
            more time would be on the small judgment calls under
            pressure, like does Genre get to exist in a product that&apos;s
            centered around a feeling and make those calls with people
            other than in my own head a bit sooner. Thermal is a personal
            project I&apos;m currently working on. The basic flow: landing
            page, input your discovery, tune your vibe, wait in analysis
            state, get results, are established. Next up I&apos;ll design
            the Library section for stored playlists, and polish the
